...
<div class="main">
	...
	<table class="table we7-table table-hover site-list">
		...
		<tr>
			...
			<td>
				<a href="https://www.we7.cc/" class="lightlink2" target="_blank" style="color: #428bca;">公司网站</a>&nbsp;&nbsp;
				<a href="https://s.we7.cc/goods-1.html" class="lightlink2" target="_blank" style="color: #428bca;">购买授权</a>&nbsp;&nbsp;
				<a href="https://s.we7.cc/" class="lightlink2" target="_blank" style="color: #428bca;">更多模块</a>&nbsp;&nbsp;
				<a href="https://s.we7.cc/index.php?c=wiki&do=view&id=1" class="lightlink2" target="_blank" style="color: #428bca;">文档</a>&nbsp;&nbsp;
				<a href="https://bbs.we7.cc/" class="lightlink2" target="_blank" style="color: #428bca;">讨论区</a>
			</td>
		</tr>
	</table>
	<?php  } ?>
