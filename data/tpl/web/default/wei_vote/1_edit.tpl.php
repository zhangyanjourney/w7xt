	 ...
	 <div class="panel-heading">
		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<label class="col-xs-12 col-sm-3 col-md-2 control-label">编号</label>
				
				  <div class="col-sm-9 col-xs-12">
		
					<input type="text" name="bh" class="form-control" value="<?php  echo $user_data['bh'];?>"> 
			...
			<?php  if($_W['isfounder']) { ?>
				...
				<div class="form-group">
					...
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">虚拟礼物票数：</label>
					
					<div class="col-sm-9">
						<div class="input-group">
					
						
						<input type="text" name="liwushuliang1"  readonly="readonly" class="form-control" value="<?php  echo $user_data['liwushuliang1'];?>">
						</div>
					</div>
					...
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">虚拟礼物金额：</label>
					
					<div class="col-sm-9">
						<div class="input-group">
					
						
						<input type="text" name="yuan1"  readonly="readonly" class="form-control" value="<?php  echo $user_data['yuan1'];?>">
						</div>
					</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
						<div class="input-group"><textarea name="manifesto" cols="80" rows="4"><?php  echo $user_data['feifa'];?></textarea></div>
				</div>
