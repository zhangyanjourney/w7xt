...
<div id="zhou-dialog-confirm">
    ...
    <div class="zhou-dialog">
        ...
        <div class="zhou-dialog-content">
			...
			<p>数量：<input type="text" name="shuliang" id="shuliang" value="1" /></p>
        </div>
...
<div class="lapiao">
			...
			<a href="<?php  echo $this->createMobileUrl('wulist',array('id'=>$_GPC['id'],'hdid'=>$_GPC['hdid']))?>" class="r ">礼物</a>
						
			<?php  } else { ?>
			<a href="<?php  echo $this->createMobileUrl('Paih',array('id'=>$_GPC['id'],'hdid'=>$_GPC['hdid']))?>" class="r ">排行</a>
