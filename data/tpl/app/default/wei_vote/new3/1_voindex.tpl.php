...
.index_desc_title {
  ...
  <style type="text/css">
       #xiana
       {
		   ...
		   height: 40px;
		   line-height: 40px;
		   color: #060606;    border-radius: 5px;
			color: #fff;   
       }
       #xiana a{
      color: #060606;
...
.article input{ box-sizing: content-box;width: 20%; padding: 0.6em; border-radius: 0em; font-size: 12px; z-index: 100; background-color: #44b549; border: none; position: absolute; bottom: 3%; right: 5%; color: #fff; box-shadow: 0 0 0px #d7d7d7;    background-color: #4b00a7;}
/*瀑布流结束*/
...
<body style="background-color: #6f2dff;">
...
<?php  if($this->settings[0]['display'] == 1) { ?>
		<div style="padding:10px"><a href="<?php  echo $this->createMobileUrl('weiindex',array('hdid'=>$_GPC['hdid']))?>"><div style="height:40px;line-height:40px;text-align:center;background:#4b00a7;border-radius:5px;color:#fff">我要报名</div></a></div>
<?php  } ?>
...
<div class="mui-input-row mui-search">
    ...
    <div id="wsp">
              <div id="rank-1" class="one" style="    background-color: #6f2dff;transform-origin: 0px 0px 0px; opacity: 1; transform: scale(1, 1);">
    ...
    <div id="new-list" class="one" style="    background-color: #6f2dff;transform-origin: 0px 0px 0px; opacity: 1; transform: scale(1, 1); ">
  ...
  <?php  if($this->settings[0]['huodong_sm'] != '') { ?>
                <div class ="pd" style="margin-bottom: 50px; padding-bottom: 20px;background: #fff; overflow: hidden;color: #fbc108; background-color: #4b00a7;">
							<!-- 	<div class="index_desc_title"><i class="iconfont icon-huodongjieshao"></i>活动介绍</div> -->
								<div class="bg-purple5 cl-yellow" style="width:40%;border-radius:20px; height:36px; line-height:36px;margin:0 auto; text-align:center;margin-top: 30px;">活动规则</div>
